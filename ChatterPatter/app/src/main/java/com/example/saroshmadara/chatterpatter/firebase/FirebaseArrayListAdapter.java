...
public abstract class FirebaseArrayListAdapter<T> extends ArrayAdapter<T> {
     ...
     */
    public FirebaseArrayListAdapter(Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
    ...
    public void addEventListener(){
        mListener = this.mRef.addChildEventListener(new ChildEventListener() {
            private FirebaseArrayListAdapter<T> outter = FirebaseArrayListAdapter.this;
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {

                T model = dataSnapshot.getValue(FirebaseArrayListAdapter.this.mModelClass);
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                T newModel = dataSnapshot.getValue(FirebaseArrayListAdapter.this.mModelClass);
