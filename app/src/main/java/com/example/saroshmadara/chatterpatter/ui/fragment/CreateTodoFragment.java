...
import com.example.saroshmadara.chatterpatter.model.Todo;
...
public class CreateTodoFragment extends Fragment {
    ...
    private static final String TAG = "CreateTodoFragment" ;
...
//                if(getActivity().getSupportFragmentManager().getBackStackEntryCount() < 2) {
                getActivity().getSupportFragmentManager().popBackStackImmediate("Home",1);
            }
        });
